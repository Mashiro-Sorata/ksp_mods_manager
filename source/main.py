...
if __name__ == '__main__':
    ...
    if not os.path.isfile(r'.\data\mainData.json'):
        ...
        frm1 = InitCfgFrame(None, title='Settings',size=(600,250),style=wx.MINIMIZE_BOX | wx.SYSTEM_MENU | wx.CAPTION | wx.CLOSE_BOX | wx.CLIP_CHILDREN)
        if inspath:
            frm1.InspText.SetValue(inspath)
        frm1.ModText.SetValue(os.path.join(os.getcwd(),'Mods'))
        frm1.Center()
        frm1.Show()
    else:
